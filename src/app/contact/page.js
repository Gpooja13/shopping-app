      ...
      <div className="container px-5 md:py-24 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            width="100%"
            height="100%"
            style={{ border: 0, filter: "opacity(0.8)" }}
          ...
          <div className="bg-white relative flex flex-wrap py-6 mx-6 rounded shadow-md">
        ...
        <div className="lg:w-1/3 md:w-1/2 bg-white flex flex-col md:ml-auto w-full md:py-2 mt-8 md:mt-0">
          ...
          <form action="https://formspree.io/f/xvoewwbk" method="POST" className="relative mb-4" >
            ...
            ></textarea>
            <button
              className="text-white bg-purple-500 border-0 py-2 px-6 focus:outline-none hover:bg-purple-600 rounded text-lg w-full mt-5"
              type="submit"
            >
              Submit
            </button>
